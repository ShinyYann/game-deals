...
GAME_DETAILS = {
    ...
    # Keys: English lowercase (with or without spaces) OR Chinese (without 《》)
    ...
    '艾尔登法环': ('宫崎英高与乔治·R·R·马丁联手打造的动作RPG史诗。穿越「狭间之地」，挑战半神，揭开法环碎裂之谜。辽阔的开放世界令人惊叹，隐藏地牢与巨型Boss战充满探索欲。', ['动作RPG', 'MC96 年度最佳', 'TGA 2022年度游戏', '开放世界标杆'], 'BV1q5411c7aP'),
    ...
    '对马岛之魂': ('以1274年元日战争为背景的开放世界动作冒险。武士境井仁在蒙古入侵下化身「战鬼」，守护对马岛。绝美的日本风光、爽快的刀剑对决、沉浸的和风叙事。', ['开放世界动作', 'MC87 佳作', '武士题材必玩', '玩家选择奖'], 'BV1d4411f7Q6'),
    '对马岛': ('以1274年元日战争为背景的开放世界动作冒险。武士境井仁在蒙古入侵下化身「战鬼」，守护对马岛。绝美的日本风光、爽快的刀剑对决、沉浸的和风叙事。', ['开放世界动作', 'MC87 佳作', '武士题材必玩', '玩家选择奖'], 'BV1d4411f7Q6'),
    ...
    '生化危机4': ('经典生存恐怖系列巅峰之作。特工里昂前往欧洲村庄营救总统女儿。完美融合动作射击与恐怖氛围，关卡设计教科书级别。重制版画质大幅提升，战斗系统更流畅。', ['动作恐怖', 'MC93 必玩神作', '系列天花板', '最佳重制'], 'BV1Xk4y1q7Qp'),
    ...
    '女神异闻录5 皇家版': ('风格前卫的日式角色扮演游戏。白天是高中生，夜晚化身怪盗潜入心灵迷宫。UI设计独树一帜，剧情深刻，BGM神级。皇家版加入新角色和第三学期内容。', ['日式RPG', 'MC95 神作', '200小时+内容量', '原声封神'], 'BV1JZ4y1X7YW'),
    '女神异闻录5': ('风格前卫的日式角色扮演游戏。白天是高中生，夜晚化身怪盗潜入心灵迷宫。UI设计独树一帜，剧情深刻，BGM神级。皇家版加入新角色和第三学期内容。', ['日式RPG', 'MC95 神作', '200小时+内容量', '原声封神'], 'BV1JZ4y1X7YW'),
    ...
    '赛博朋克2077': ('开放世界科幻RPG。在夜之城扮演雇佣兵V追寻永生。初期优化翻车，但经DLC「往日之影」与2.0大更新后彻底翻身——沉浸感爆棚的赛博朋克世界，剧情深刻，战斗爽快。', ['开放世界RPG', 'MC86 已修复', 'DLC口碑极佳', '2024年最佳翻身作'], 'BV1M3411C7mD'),
    ...
    '双影奇境': ('「双人成行」团队最新力作。两位女主角穿梭科幻世界，兼具创新玩法与感人剧情。每一关都有全新机制，画面震撼，2025年TGA年度游戏有力竞争者。', ['双人合作', 'MC91 年度黑马', '必玩双人游戏', '最佳合作游戏'], 'BV1Jw411d7vB'),
    ...
    '双人成行': ('专门为双人合作设计的动作冒险游戏。一对即将离婚的夫妻变成玩偶，在奇幻世界中修复感情。每一章都有完全不同的玩法机制。荣获TGA 2021年度游戏。', ['双人合作', 'MC90 神作', 'TGA 2021年度游戏', '情侣必玩'], 'BV1rX4y1w7Td'),
    'stellar blade': ('末世科幻动作RPG。战士夏娃在末世上与奈提巴战斗，夺回家园。战斗系统流畅华丽，女主角设计出众，BOSS战魄力十足。索尼独占品质之作。', ['动作RPG', 'MC81 佳作', '战斗爽快', '配乐出色'], 'BV1wZ421e7zh'),
    '剑星': ('末世科幻动作RPG。战士夏娃在末世上与奈提巴战斗，夺回家园。战斗系统流畅华丽，女主角设计出众，BOSS战魄力十足。索尼独占品质之作。', ['动作RPG', 'MC81 佳作', '战斗爽快', '配乐出色'], 'BV1wZ421e7zh'),
    ...
    '黑神话': ('国产动作游戏里程碑。扮演「天命人」在东方奇幻世界探索，体验西游故事的全新演绎。画面表现力惊艳，Boss战设计出色，战斗系统扎实。全球销量破千万。', ['动作RPG', 'MC81 国产之光', '画面顶级', '中文文化输出'], 'BV14M4m1y7Gd'),
    '黑神话悟空': ('国产动作游戏里程碑。扮演「天命人」在东方奇幻世界探索，体验西游故事的全新演绎。画面表现力惊艳，Boss战设计出色，战斗系统扎实。全球销量破千万。', ['动作RPG', 'MC81 国产之光', '画面顶级', '中文文化输出'], 'BV14M4m1y7Gd'),
    ...
    '真·三國無雙 起源': ('「一骑当千」的爽快动作系列。三国武将横扫千军。真·三国无双 起源是系列革新之作，战斗系统大幅进化，战场氛围更真实。', ['动作割草', 'MC80 系列革新', '爽快解压', '起源口碑回升'], 'BV1RJ411q7o6'),
    '真三国无双 起源': ('「一骑当千」的爽快动作系列。三国武将横扫千军。真·三国无双 起源是系列革新之作，战斗系统大幅进化，战场氛围更真实。', ['动作割草', 'MC80 系列革新', '爽快解压', '起源口碑回升'], 'BV1RJ411q7o6'),
    ...
    '跑车浪漫旅': ('索尼第一方赛车模拟巅峰。海量真实车型和赛道，逼真驾驶体验与出色画面。GT系列25周年集大成之作，从新车手到老司机都能找到乐趣。', ['赛车模拟', 'MC87 最佳竞速', '真实驾驶体验', '系列25周年'], 'BV1t44y1q7LL'),
...
.modal {{ background: linear-gradient(145deg, #1f1f35, #18182a); border-radius: 20px; max-width: 500px; width: 100%; max-height: 85vh; overflow-y: auto; padding: 0; position: relative; transform: translateY(30px) scale(0.95); opacity: 0; transition: transform 0.35s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.3s ease; box-shadow: 0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.05); }}
